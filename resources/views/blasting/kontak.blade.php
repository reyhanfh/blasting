        ...
        <div class="card mb-3">
            <div class="card-header">
                  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2">
                      ...
                      <a href="{{ url('blasting/kontak/create') }}"><button class="btn btn-primary btn-sm" type="button">Add Data</button></a>
                      </div>
                  </div> 
            </div>              
            <div class="card-body">
            <kontak-list :asset-url="{{ json_encode(asset('/')) }}"></kontak-list> 
          </div>
        </div>
    </div>
</div>                 

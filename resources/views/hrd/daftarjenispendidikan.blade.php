        ...
        <div class="card mb-3">
            <div class="card-header">
                  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2">
                      ...
                      <a href="{{ url('daftarjenispendidikan/tambahdaftarjenispendidikan') }}"><button class="btn btn-primary btn-sm" type="button">Create</button></a>
                      </div>
                  </div> 
            </div>              
            <div class="card-body">
            <daftarjenispendidikan></daftarjenispendidikan> 
          </div>
        </div>
    </div>
</div>                 

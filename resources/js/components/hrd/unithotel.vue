<template>
      ...
      <b-table bordered striped hover :items="filteredItems" :fields="fields" :per-page="perPage" :current-page="currentPage">
        ...
        <template v-slot:cell(actions)="data">
          <div class="text-center">
            <a :href="`unithotel/editunithotel/${data.item.id}`" class="btn btn-primary btn-sm">Update</a>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'kode', label: 'Kode', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'namaunit', label: 'Nama Unit', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'hrleader', label: 'HR Leader', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'kota', label: 'Kota', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'telp', label: 'Telp', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'email', label: 'Email', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
    ...
    methods: {
      fetchData() {
        axios.get(this.$root.baseurl + 'unithotel/getallunithotel').then(response => {

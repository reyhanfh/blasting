...
export default {
    ...
    created() {
        axios
            .get(`/cuti/prevpengajuancuti/${this.id}`, {
                headers: {
            ...
            .then((response) => {
                ...
                this.form.tanggalpengajuan = response.data.tanggalpengajuan;
                this.form.idjeniscuti = response.data.idjeniscuti;
                this.form.dari = response.data.dari;
                this.form.sampai = response.data.sampai;
                this.form.keterangan = response.data.keterangan;
                this.form.alamatcuti = response.data.alamatcuti;
                this.form.kontak = response.data.kontak;
                this.form.harikerja = response.data.harikerja;
            })
            .catch((error) => {
                console.log(error);
            });
    ...
    methods: {
        ...
        async submitForm() {
            try {
                await axios.post("/cuti/updatepengajuancuti", this.form, {
                    headers: {
                        "X-CSRF-TOKEN": this.csrf,
                    },
                });
        ...
        cancel() {
            window.location.href = "/cuti/pengajuancuti";
        },

<template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'fakultas', label: 'Fakultas', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
    ...
    methods: {
      fetchData() {
        axios.get(this.$root.baseurl + 'daftarfakultas/getalldaftarfakultas').then(response => {

<template>
      ...
      <b-table bordered striped hover :items="filteredItems" :fields="fields" :per-page="perPage" :current-page="currentPage">
        ...
        <template v-slot:cell(actions)="data">
          <div class="text-center">
            <a :href="`/daftarpegawai/editdaftarpegawai/${data.item.id}`" class="btn btn-primary btn-sm">Update</a>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'nip', label: 'NIP', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'namalengkap', label: 'Nama Pegawai', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'namadepartemen', label: 'Departemen', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'namalevel', label: 'Jabatan', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
    ...
    methods: {
      fetchData() {
        axios.get(this.$root.baseurl + 'daftarpegawai/getalldaftarpegawai').then(response => {

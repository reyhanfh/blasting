    ...
    <div>
        ...
        >
            ...
            <template v-slot:cell(actions)="data">
                <div class="text-center">
                    <a
                        :href="`/daftarjenispendidikan/editdaftarjenispendidikan/${data.item.id}`"
    ...
    methods: {
        fetchData() {
            axios
                .get(
                    this.$root.baseurl +
                        "daftarjenispendidikan/getalldaftarjenispendidikan"
                )
                .then((response) => {
        ...
        deleteItem(id) {
            if (confirm("Yakin mau menghapus data ini?")) {
                axios
                    .get(this.$root.baseurl + "blasting/kontak/delete/" + id, {
                        headers: {
                            _token: this.csrf,
                        },
                    })

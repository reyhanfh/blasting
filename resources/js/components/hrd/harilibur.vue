<template>
      ...
      <b-table bordered striped hover :items="filteredItems" :fields="fields" :per-page="perPage" :current-page="currentPage">
        ...
        <template v-slot:cell(actions)="data">
          <div class="text-center">
            <a :href="`/harilibur/editharilibur/${data.item.id}`" class="btn btn-primary btn-sm">Update</a>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'keterangan', label: 'Keterangan', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
    ...
    methods: {
      fetchData() {
        axios.get(this.$root.baseurl + 'harilibur/getallharilibur').then(response => {

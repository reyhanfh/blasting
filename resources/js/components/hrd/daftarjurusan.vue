<template>
      ...
      <b-table bordered striped hover :items="filteredItems" :fields="fields" :per-page="perPage" :current-page="currentPage">
        ...
        <template v-slot:cell(actions)="data">
          <div class="text-center">
            <a :href="`/daftarjurusan/editdaftarjurusan/${data.item.id}`" class="btn btn-primary btn-sm">Update</a>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'kodejurusan', label: 'Kode Jurusan', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'jurusan', label: 'Nama Jurusan', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
    ...
    methods: {
      fetchData() {
        axios.get(this.$root.baseurl + 'daftarjurusan/getalldaftarjurusan').then(response => {

<template>
      ...
      <b-table bordered striped hover :items="filteredItems" :fields="fields" :per-page="perPage" :current-page="currentPage">
        ...
        <template v-slot:cell(actions)="data">
          <div class="text-center">
            <a :href="`/leveljabatan/editleveljabatan/${data.item.id}`" class="btn btn-primary btn-sm">Update</a>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'namalevel', label: 'Nama Level', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'uangsaku_7h', label: 'Uang Saku 7h', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'uangsaku_29h', label: 'Uang Saku 29h', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'uangsaku_30h', label: 'Uang Saku 30h', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'uangsaku_unit', label: 'Uang Saku Unit', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'uangmakan', label: 'Uang Makan', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
    ...
    methods: {
      fetchData() {
        axios.get(this.$root.baseurl + 'leveljabatan/getallleveljabatan').then(response => {

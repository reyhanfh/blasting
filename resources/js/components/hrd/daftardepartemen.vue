<template>
      ...
      <b-table bordered striped hover :items="filteredItems" :fields="fields" :per-page="perPage" :current-page="currentPage">
        ...
        <template v-slot:cell(actions)="data">
          <div class="text-center">
            <a :href="`/daftardepartemen/editdaftardepartemen/${data.item.id}`" class="btn btn-primary btn-sm">Update</a>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'kodedepartemen', label: 'Kode Departemen', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
          { key: 'namadepartemen', label: 'Nama Departemen', thStyle: { 'text-align': 'center' }, tdClass: 'text-center' },
    ...
    methods: {
      fetchData() {
        axios.get(this.$root.baseurl + 'daftardepartemen/getalldaftardepartemen').then(response => {
